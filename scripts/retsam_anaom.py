...
times = create_seed_times(reader0.end_time, 
                          reader0.start_time, timedelta(hours = -1))

times = [reader0.end_time, reader0.start_time]

number = 8000
z = np.random.uniform(-10,0,size=8000) # generate random depth

o.seed_elements(lon, lat, number = number, radius=2500, radius_type='uniform',time = times, z = z)
...
o.run(stop_on_error=False,
      end_time=readerminus2.start_time,
      time_step=-3600, 
